...
import com.procialize.mrgeApp20.Activity.ImageMultipleActivity;
...
public class SwipeMultimediaAdapter extends PagerAdapter {
    ...
    public SwipeMultimediaAdapter(Context context, List<String> images, List<String> thumbImages, List<com.procialize.mrgeApp20.GetterSetter.news_feed_media> news_feed_media) {
