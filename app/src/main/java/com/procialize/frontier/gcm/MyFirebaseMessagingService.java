package com.procialize.frontier.gcm;
...
import com.procialize.frontier.Activity.SplashActivity;
import com.procialize.frontier.ApiConstant.ApiConstant;
import com.procialize.frontier.AttendeeChat.AttendeeChatActivity;
import com.procialize.frontier.BuddyList.Activity.ActivityBuddyChat;
...
//        Bundle[{google.delivered_priority=normal, google.sent_time=1583143282324, google.ttl=2419200, google.original_priority=normal, contentText=context, from=321746269511, image=, title=For Developer Use, event_id=43, google.message_id=0:1583143283357256%82707a1df9fd7ecd, contentTitle=title, message=Admin has sent you a notification - "TEST", google.c.sender.id=321746269511, tickerText=ticker}]
        ...
        if (strEventId.equalsIgnoreCase(event_id)) {
            ...
            try {
                ...
                {
                   // com.procialize.frontier.Background.BackgroundService.successfullUploadedMediaCount =com.procialize.frontier.Background.BackgroundService.successfullUploadedMediaCount++;
                    String[] message = remoteMessage.getData().get("message").split("#");
...
//        Bitmap largeIcon = BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if (Build.BRAND.equalsIgnoreCase("samsung")) {
                    ...
                    notificationBuilder.setSmallIcon(R.drawable.frontierlogo);
...
//            notificationBuilder.setColor(getResources().getColor(R.color.activetab));
            ...
            notificationBuilder.setContentTitle("Frontier")
                    .setColorized(true)
                    .setWhen(when)
                    .setAutoCancel(true)
                    .setShowWhen(true)
       ...
       } else if(messageType.contains("spot_poll"))
       {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (Build.BRAND.equalsIgnoreCase("samsung")) {
                ...
                mBuilder.setSmallIcon(R.drawable.frontierlogo);
...
//        mBuilder.setSmallIcon(getNotificationIcon())
        ...
        if(image!=null) {
            mBuilder.setContentTitle("Frontier")
                    .setLargeIcon(image)
                    .setColorized(true)
                    .setSound(alarmSound)
                    .setWhen(when)
