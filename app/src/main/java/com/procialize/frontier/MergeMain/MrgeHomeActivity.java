package com.procialize.frontier.MergeMain;
...
import com.procialize.frontier.Activity.FrontierSpecial;
import com.procialize.frontier.Activity.GameActivity;
import com.procialize.frontier.Activity.LoginActivity;
import com.procialize.frontier.Activity.PrivacyPolicy;
import com.procialize.frontier.Activity.ProfileActivity;
import com.procialize.frontier.Activity.VideoGallery;
import com.procialize.frontier.Activity.WebViewActivity;
...
import com.procialize.frontier.Background.WallPostService;
...
import com.procialize.frontier.DialogLivePoll.DialogLivePoll;
import com.procialize.frontier.DialogQuiz.DialogQuiz;
import com.procialize.frontier.Downloads.DownloadsFragment;
import com.procialize.frontier.Engagement.Fragment.EngagementFragment;
import com.procialize.frontier.Fragments.AttendeeFragment;
import com.procialize.frontier.Gallery.Image.Activity.GalleryFragment;
import com.procialize.frontier.Gallery.Video.Activity.VideoFragment;
import com.procialize.frontier.GetterSetter.AgendaList;
import com.procialize.frontier.GetterSetter.EventMenuSettingList;
...
import com.procialize.frontier.GetterSetter.YouTubeApiList;
import com.procialize.frontier.InnerDrawerActivity.EventInfoActivity;
import com.procialize.frontier.InnerDrawerActivity.FeedBackActivity;
import com.procialize.frontier.InnerDrawerActivity.NotificationActivity;
import com.procialize.frontier.InnerDrawerActivity.NotificationExhibitorActivity;
import com.procialize.frontier.NewsFeed.Views.Fragment.FragmentNewsFeed;
...
import com.procialize.frontier.Speaker.Views.SpeakerFragment;
import com.procialize.frontier.Utility.KeyboardUtility;
import com.procialize.frontier.Utility.PlayerConfig;
import com.procialize.frontier.Utility.Res;
...
//import com.procialize.frontier.Adapter.CustomMenuAdapter;
...
public class MrgeHomeActivity extends AppCompatActivity {//implements CustomMenuAdapter.CustomMenuAdapterListner {
    ...
    TextView logout, buddyList, editProfile, side_video_gallery,feedback, notifications, game, home, frontier_special, gallery, contactus, eventname, switchbt, chatbt, eula, privacy_policy, eventInfo, notification, exh_analytics, txt_version;
    String eventnamestr;
    LinearLayout linear;
...
//        navigationView.setLayoutParams(params);
        ...
        game = navigationView.findViewById(R.id.game);
        feedback = navigationView.findViewById(R.id.feedback);
        notifications = navigationView.findViewById(R.id.notifications);
        ...
        gallery = navigationView.findViewById(R.id.gallery);
        frontier_special = navigationView.findViewById(R.id.frontier_special);
        side_video_gallery = navigationView.findViewById(R.id.side_video_gallery);
        ...
        frontier_special.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MrgeHomeActivity.this, FrontierSpecial.class);
                startActivity(intent);
        ...
        feedback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MrgeHomeActivity.this, FeedBackActivity.class);
                startActivity(intent);

            }
        });

        side_video_gallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MrgeHomeActivity.this, VideoGallery.class);
                startActivity(intent);
...
//                finish();
        ...
        game.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent main = new Intent(getApplicationContext(), GameActivity.class);
                startActivity(main);
//                finish();
            }
        });
...
//                tabLayout.getTabAt(0).setIcon(tabIcons[0]);
                tabLayout.getTabAt(0).setIcon(R.drawable.newsffed_selector);
            } else if (tabLayout.getTabAt(0).getText().equals("Attendee")) {
//                tabLayout.getTabAt(0).setIcon(tabIcons[1]);
                tabLayout.getTabAt(0).setIcon(R.drawable.attendee_selector);
            } else if (tabLayout.getTabAt(0).getText().equals("Engagement")) {
//                tabLayout.getTabAt(0).setIcon(tabIcons[2]);
                tabLayout.getTabAt(0).setIcon(R.drawable.engagement_selector);
        ...
        if (tabLayout.getTabAt(1) != null) {
            if (tabLayout.getTabAt(1).getText().equals("News Feed")) {
                tabLayout.getTabAt(1).setIcon(R.drawable.newsffed_selector);
            } else if (tabLayout.getTabAt(1).getText().equals("Attendee")) {
                tabLayout.getTabAt(1).setIcon(R.drawable.attendee_selector);
            } else if (tabLayout.getTabAt(1).getText().equals("Engagement")) {
                tabLayout.getTabAt(1).setIcon(R.drawable.engagement_selector);
            } /*else if (tabLayout.getTabAt(0).getText().equals("Interact")) {
                tabLayout.getTabAt(0).setIcon(tabIcons[3]);
            } else if (tabLayout.getTabAt(0).getText().equals("Exhibitors")) {
                tabLayout.getTabAt(0).setIcon(tabIcons[4]);
        ...
        if (tabLayout.getTabAt(2) != null) {
            if (tabLayout.getTabAt(2).getText().equals("News Feed")) {
                tabLayout.getTabAt(2).setIcon(R.drawable.newsffed_selector);
            } else if (tabLayout.getTabAt(2).getText().equals("Attendee")) {
                tabLayout.getTabAt(2).setIcon(R.drawable.attendee_selector);
            } else if (tabLayout.getTabAt(2).getText().equals("Engagement")) {
                tabLayout.getTabAt(2).setIcon(R.drawable.engagement_selector);
            } /*else if (tabLayout.getTabAt(0).getText().equals("Interact")) {
                tabLayout.getTabAt(0).setIcon(tabIcons[3]);
            } else if (tabLayout.getTabAt(0).getText().equals("Exhibitors")) {
                tabLayout.getTabAt(0).setIcon(tabIcons[4]);
        ...
        if (tabLayout.getTabAt(3) != null) {
            if (tabLayout.getTabAt(3).getText().equals("News Feed")) {
                tabLayout.getTabAt(3).setIcon(R.drawable.newsffed_selector);
            } else if (tabLayout.getTabAt(3).getText().equals("Attendee")) {
                tabLayout.getTabAt(3).setIcon(R.drawable.attendee_selector);
            } else if (tabLayout.getTabAt(3).getText().equals("Engagement")) {
                tabLayout.getTabAt(3).setIcon(R.drawable.engagement_selector);
            } /*else if (tabLayout.getTabAt(0).getText().equals("Interact")) {
                tabLayout.getTabAt(0).setIcon(tabIcons[3]);
            } else if (tabLayout.getTabAt(0).getText().equals("Exhibitors")) {
                tabLayout.getTabAt(0).setIcon(tabIcons[4]);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        if (attendee.equalsIgnoreCase("1")) {
            adapter.addFragment(new AttendeeFragment(MrgeHomeActivity.this), "Attendee");
        }

//        if (engagement.equalsIgnoreCase("1")) {
        adapter.addFragment(new EngagementFragment(MrgeHomeActivity.this), "Engagement");
//        }
...
//                        list_image_view.setVisibility(View.INVISIBLE);
                        ...
                        if (tab.getText().equals("Attendee")) {
//                            Subviewpager.setPagingEnabled(false);
