...
public class ExhibitorAdapter extends RecyclerView.Adapter<ExhibitorAdapter.MyViewHolder> implements Filterable {
    ...
    private List<com.procialize.frontier.GetterSetter.ExhibitorDataList> eventListfilter;
    String MY_PREFS_NAME = "ProcializeInfo";
    String MY_PREFS_LOGIN = "ProcializeLogin";
    String colorActive, CatName;

    public ExhibitorAdapter(Context context, List<com.procialize.frontier.GetterSetter.ExhibitorDataList> ExhibitorDataList, ExhibitorAdapterListner listener, String CatName) {
    ...
    public void onBindViewHolder(@NonNull final ExhibitorAdapter.MyViewHolder holder, int position) {
        ...
        final com.procialize.frontier.GetterSetter.ExhibitorDataList evnt = eventListfilter.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<com.procialize.frontier.GetterSetter.ExhibitorDataList> filteredList = new ArrayList<>();
                    for (com.procialize.frontier.GetterSetter.ExhibitorDataList row : ExhibitorDataList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults
                    filterResults) {
                eventListfilter = (ArrayList<com.procialize.frontier.GetterSetter.ExhibitorDataList>) filterResults.values;
    ...
    public interface ExhibitorAdapterListner {
        void onContactSelected(com.procialize.frontier.GetterSetter.ExhibitorDataList eventList);
    }
