package com.procialize.frontier.Exhibitor.Adapter;
...
import com.procialize.frontier.Activity.ExhibitorListingActivity;
...
public class ExhibitorListingAdapter extends RecyclerView.Adapter<ExhibitorListingAdapter.MyViewHolder> implements Filterable {
    ...
    List<com.procialize.frontier.GetterSetter.ExhibitorDataList> ExhibitorDataList;
    private List<com.procialize.frontier.GetterSetter.ExhibitorCatList> ExhibitorCatList;
    private List<com.procialize.frontier.GetterSetter.ExhibitorAttendeeList> ExhibitorAttendeeList;
    private Context context;
    private ExhibitorAdapterListner listener;
    private List<com.procialize.frontier.GetterSetter.ExhibitorCatList> eventListfilter;
    String MY_PREFS_NAME = "ProcializeInfo";
    String MY_PREFS_LOGIN = "ProcializeLogin";
    String colorActive;

    public ExhibitorListingAdapter(Context context, List<com.procialize.frontier.GetterSetter.ExhibitorCatList> ExhibitorCatList, List<com.procialize.frontier.GetterSetter.ExhibitorDataList> ExhibitorDataList, ExhibitorAdapterListner listener) {
    ...
    public void onBindViewHolder(@NonNull ExhibitorListingAdapter.MyViewHolder holder, int position) {
       ...
       /* if (position == 0) {
        ...
        final com.procialize.frontier.GetterSetter.ExhibitorCatList evnt = ExhibitorCatList.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<com.procialize.frontier.GetterSetter.ExhibitorCatList> filteredList = new ArrayList<>();
                    for (com.procialize.frontier.GetterSetter.ExhibitorCatList row : ExhibitorCatList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults
                    filterResults) {
                eventListfilter = (ArrayList<com.procialize.frontier.GetterSetter.ExhibitorCatList>) filterResults.values;
    ...
    public interface ExhibitorAdapterListner {
        void onContactSelected(com.procialize.frontier.GetterSetter.ExhibitorCatList eventList);
    }
