...
public class CustomViewPagerTab extends ViewGroup {
    ...
    public interface OnPageChangeListener {
         ...
         * @see CustomViewPagerTab#SCROLL_STATE_IDLE
         * @see CustomViewPagerTab#SCROLL_STATE_DRAGGING
         * @see CustomViewPagerTab#SCROLL_STATE_SETTLING
         */
