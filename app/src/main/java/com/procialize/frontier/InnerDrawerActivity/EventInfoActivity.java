...
import com.procialize.frontier.Adapter.SponsorAdapter;
...
import static com.procialize.frontier.Session.ImagePathConstants.KEY_EVENT_LOGO_PATH;
...
public class EventInfoActivity extends AppCompatActivity implements OnMapReadyCallback , SponsorAdapter.SponsorAdapterListner {
    ...
    TextView tv_sponsor_header,event_venue;
    View view_venue;
    @Override
...
//        eventnamestr=intent.getStringExtra("eventnamestr");
       ...
       // toolbar.getNavigationIcon().setColorFilter(getResources().getColor(R.color.activetab), PorterDuff.Mode.SRC_ATOP);
        ...
        tv_sponsor_header = findViewById(R.id.tv_sponsor_header);
        event_venue = findViewById(R.id.event_venue);
        view_venue = findViewById(R.id.view_venue);
    ...
    public void showResponse(final Response<EventInfoFetch> response) {
        ...
        if (response.body().getEventList().isEmpty()) {
                ...
                public void run() {
                    ...
                    if (eventDBList.size() != 0) {
                        ...
                        try {
                            ...
                            Glide.with(EventInfoActivity.this).load(image_final_url)
            ...
            if (response.body().getStatus().equalsIgnoreCase("success")) {
                ...
                SponsorAdapter sponsorAdapter = new SponsorAdapter(this, sponsorList, filePath,EventInfoActivity.this);
