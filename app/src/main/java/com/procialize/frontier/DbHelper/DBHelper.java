package com.procialize.frontier.DbHelper;
...
import com.procialize.frontier.BuddyList.DataModel.Buddy;
import com.procialize.frontier.BuddyList.DataModel.chat_list;
import com.procialize.frontier.BuddyList.DataModel.chat_list_db;
import com.procialize.frontier.GetterSetter.AgendaList;
import com.procialize.frontier.GetterSetter.AgendaMediaList;
import com.procialize.frontier.GetterSetter.AgendaVacationList;
import com.procialize.frontier.GetterSetter.AttendeeList;
import com.procialize.frontier.GetterSetter.EventList;
...
import com.procialize.frontier.GetterSetter.Exhibitor_Meeting_Request_List;
import com.procialize.frontier.GetterSetter.Exhibitor_Notification_List;
...
import com.procialize.frontier.Speaker.Models.SpeakerList;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String MULTIMEDIA_TEXT = "MULTIMEDIA_TEXT";
    ...
    public ArrayList<NewsFeedPostMultimedia> getNotUploadedMultiMedia() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                newsFeedPostMultimedia.setPostText(cursor.getString(1));
                newsFeedPostMultimedia.setMedia_file(cursor.getString(2));
                newsFeedPostMultimedia.setMedia_file_thumb(cursor.getString(3));
                newsFeedPostMultimedia.setCompressedPath(cursor.getString(4));
