...
import com.procialize.frontier.NewsFeed.Views.Adapter.SwipeMultimediaDetailsAdapter;
...
public class ImageMultipleActivity extends AppCompatActivity {
    ...
    int position = 0;
    List<com.procialize.frontier.GetterSetter.news_feed_media> news_feed_media;
