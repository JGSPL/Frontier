package com.procialize.frontier.NewsFeed.Views.Fragment;
...
import com.procialize.frontier.Background.BackgroundService;
...
import com.procialize.frontier.NewsFeed.Views.Activity.ImageViewActivity;
import com.procialize.frontier.NewsFeed.Views.Activity.LikeDetailActivity;
import com.procialize.frontier.NewsFeed.Views.Activity.PostNewActivity;
import com.procialize.frontier.NewsFeed.Views.Adapter.NewsFeedAdapterRecycler;
import com.procialize.frontier.NewsFeed.Views.RecyclerItemTouchHelper;
    ...
    public void shareImage(final String data, String url, final Context context) {
        ...
        Picasso.with(context).load(url).into(new Target() {
            ...
            public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                ...
                context.startActivity(Intent.createChooser(i, "Shared via Frontier app"));
            }
...
//------------------------------------------------------------
        mAPIService.AttendeeFetchPost(token, eventid,"2000").enqueue(new Callback<FetchAttendee>() {
            @Override
...
//            likeimage.setBackgroundResource(R.drawable.ic_afterlike);
                            ...
                            builder.setPositiveButton("YES",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog,
                                            ...
                                            SharedPreferences prefs = getActivity().getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
                                            String newsFeedPath = prefs.getString(KEY_NEWSFEED_PATH, "");
                                            new DownloadFile().execute(newsFeedPath + newsFeedMedia.get(swipableAdapterPosition).getMediaFile());
                                        }
                                    });
                            builder.show();
    ...
    private void shareTextUrl(String data, String url) {
        ...
        startActivity(Intent.createChooser(share, "Shared via Frontier app!"));
    }
