...
import com.procialize.frontier.Adapter.SwipeAgendaImageAdapter;
import com.procialize.frontier.Adapter.SwipepagerAgendaImage;
...
import com.procialize.frontier.CustomTools.AutoScrollViewPager;
...
//        linTab.setSelected(true);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        crashlytics("Agenda Folder",user.get(SessionManager.KEY_TOKEN));
        firbaseAnalytics(getActivity(), "Agenda Folder", token);
