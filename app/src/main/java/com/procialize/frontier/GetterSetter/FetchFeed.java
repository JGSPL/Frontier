...
public class FetchFeed {
    ...
    @Expose
    private com.procialize.frontier.GetterSetter.live_steaming_info live_steaming_info;
    ...
    public com.procialize.frontier.GetterSetter.live_steaming_info getLive_steaming_info() {
        return live_steaming_info;
    }

    public void setLive_steaming_info(com.procialize.frontier.GetterSetter.live_steaming_info live_steaming_info) {
