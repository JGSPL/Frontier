package com.procialize.frontier.Gallery.Video.Adapter;
...
import static com.procialize.frontier.Utility.Util.getYoutubeVideoIdFromUrl;
...
//            }
    ...
    public interface VideoFirstLevelAdapterListner {
        void onContactSelected(FirstLevelFilter firstLevelFilter,List<FirstLevelFilter> filtergallerylist);
    }
        ...
        public MyViewHolder(View view) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    listener.onContactSelected(videoLists.get(getAdapterPosition()),videoLists);
                }
            });
        }
    }
